        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="top-menu ms-auto">
                <ul class="navbar-nav align-items-center">
                    ...
                    <li class="nav-item dropdown dropdown-large" onclick="loadNotifications()">
                        <a id="notifi"  class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#"

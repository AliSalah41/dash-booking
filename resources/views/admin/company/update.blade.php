            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-primary">{{ __('words.update_company') }}</h5>
                    </div>
                    <hr>
                    <form class="row g-3" action='{{ route('companies.store') }}' method="POST">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group"> <span class="input-group-text bg-transparent">
                                ...
                                <input type="number" value="{{ $company->type }}" name="type" class="form-control border-start-0" id="inputLastName1"
                                    placeholder="{{ __('words.type') }}" />
                            </div>
                            @error('type')
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group"><span class="input-group-text bg-transparent"><i
                                ...
                                <input type="number" value="{{ $company->price }}" class="form-control border-start-0" id="price"
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group"><span class="input-group-text bg-transparent"><i
                                        class="bx bxs-phone"></i></span>
                                <input type="number" value="{{ $company->total_available }}" class="form-control border-start-0" id="inputPhone"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group"> <span class="input-group-text bg-transparent">
                                    <i class='bx bxs-user'></i></span>
                                <input type="text" name="available" value="{{ $company->available }}" class="form-control border-start-0"
                                ...
                                @foreach (config('app.languages') as $key => $value)
                                    <div id="{{ $key }}" class="tab-pane fade @if($loop->index == 0) show active in @endif">
                                            <div class="form-group">
                                                <label for="name">{{ __('words.company_name') }}:</label>
                                                <input type="text" class="form-control" value="{{$company->translate($key)->name??'' }}" id="name" name="{{ $key }}[name]">
                                            </div>

                                            <div class="form-group">
                                                <label for="details">{{ __('words.details') }}:</label>
                                                <input class="form-control" value="{{$company->translate($key)->details??'' }}" id="details" name="{{ $key }}[details]">
                                            </div>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div class="col-12 d-flex">
                            <button type="submit"
                                class="btn btn-primary px-5 ms-auto">{{ __('words.update_company') }}</button>
                        </div>
                    </form>
                </div>
            </div>

                    ...
                    <div class="table-responsive">
                        <table id="example2" class="table table-striped table-bordered">
                            ...
                            <tr>
                                <td>user details</td>
                                <td>
                                    <span style="color: #0082a2">    User name : </span>       {{ $ticket->user->name ?? '-' }}
                                    <br>
                                    <span style="color: #0082a2">    Nickname : </span>       {{ $ticket->user->nickName?? '-' }}
                                    <br>
                            ...
                            <tr>
                                <td>Event details</td>
                                <td>
                                    <span style="color: #0082a2">    Title : </span>     {{ $ticket->event->name ?? '-' }}
                                    <br>
                            ...
                            <tr>
                                <td>Hotel details</td>
                                <td>
                                <span style="color: #0082a2">    Room type : </span>  {{ $hotel_ticket->hotels->room_type ?? '-' }}
                                <br>
                                <span style="color: #0082a2">    price : </span>  {{ $hotel_ticket->hotel_price ?? '-' }}
                                <br>
                                <span style="color: #0082a2">    reservation start : </span>  {{ $hotel_ticket->reservation_start ?? '-' }}
                                <br>
                                <span style="color: #0082a2">    reservation end : </span>  {{ $hotel_ticket->reservation_end ?? '-' }}
                                <br>
                          ...
                          <tr>
                            ...
                            <tr>
                                ...
                                <td> {{ $ticket->airlinecountry->country_airport ?? '-' }}</td>
                            </tr>
                            <tr>

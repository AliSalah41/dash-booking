        ...
        <div class="col-xl-9 mx-auto mt-5">
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    ...
                    <hr>
                    <form class="row g-3" action='{{route('airports.store')}}' method="POST">
                        @csrf
                        <div class="col-md-12">
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group"><span class="input-group-text bg-transparent"><i
                                ...
                                <input type="text" class="form-control border-start-0" id="airport_from" name="airport_from"/>
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group"><span class="input-group-text bg-transparent"><i
                                        class="bx bxs-phone"></i></span>
                                <input type="text" class="form-control border-start-0" id="airport_to" name="airport_to"/>

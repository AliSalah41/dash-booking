            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-primary">{{ __('words.add_company_phone') }}</h5>
                    </div>
                    <hr>
                    <form class="row g-3" action='{{ route('phones.store') }}' method="POST">
                        @csrf
                        <div class="col-md-12">
                            ...
                            <div class="input-group"> <span class="input-group-text bg-transparent">
                                ...
                                <input type="text" value="{{ old('content') }}" name="content"
                        ...
                        <div class="col-12 d-flex">
                            <button type="submit" class="btn btn-primary px-5 ms-auto">{{ __('words.add_company_phone') }}</button>
                        </div>
                    </form>
                </div>
            </div>

            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-primary">{{ __('words.update_account_admin') }}</h5>
                    </div>
                    <hr>
                    <form class="row g-3" action='{{ route('admin.update', $admin->id) }}' method="POST">
                        @csrf
                        @method('put')
                        <div class="col-md-12">
                            ...
                            <div class="input-group"> <span class="input-group-text bg-transparent">
                                ...
                                <input type="text" value="{{ $admin->name }}" name="name" class="form-control border-start-0" id="inputLastName1"
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group"> <span class="input-group-text bg-transparent"><i class="bx bxs-phone"></i></span>
                                <input type="number" value="{{ $admin->phone }}" class="form-control border-start-0" id="inputPhone"
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group"> <span class="input-group-text bg-transparent"><i
                                ...
                                <input type="text" value="{{ $admin->email }}" class="form-control border-start-0" id="inputEmailAddress"
                        ...
                        <div class="col-12 d-flex">
                            <button type="submit" class="btn btn-primary px-5 ms-auto">{{ __('words.update_account_admin') }}</button>
                        </div>
                    </form>
                </div>
            </div>
